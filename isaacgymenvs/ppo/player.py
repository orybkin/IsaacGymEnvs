...
class BasePlayer(object):
    ...
    def run(self):
        ...
        self.env.test = True
        render_check = Every(self.env.render_every_episodes * self.env.max_episode_length)
        self.env.override_render = render_check.check(0)
        ...
        for _ in range(n_games):
            ...
            for n in range(self.max_steps):
                ...
                if done_count > 0:
                    self.env.override_render = render_check.check(steps[0])
