...
from isaacgymenvs.redq_original.core import TanhGaussianPolicy, Mlp, get_probabilistic_num_min, soft_update_model1_with_model2
...
class SACAgent(BaseAlgorithm):
    ...
    def __init__(self, base_name, params):
        ...
        self.q_net_list, self.q_target_net_list = q_net_list, q_target_net_list
        ...
        self.polyak = 1 - self.critic_tau
        self.delay_update_steps = 5000
        self.utd_ratio = 1
        self.entropy_backup = True
    ...
    def get_full_state_weights(self):
        ...
        state['critic_optimizer1'] = self.critic_optimizer1.state_dict()
    ...
    def set_full_state_weights(self, weights, set_epoch=True):
        ...
        self.critic_optimizer1.load_state_dict(weights['critic_optimizer1'])
    ...
    def train(self):
        ...
        while True:
            ...
            if self.epoch_num % 1000 == 0:
                ...
                if self.frame >= self.num_warmup_steps and len(critic1_losses) > 0:
